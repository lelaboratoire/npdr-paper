...
start_time <- Sys.time()
class.idx <- length(colnames(filtered.mostafavi.df))
npdr.mdd.sexassoc.rnaseq.results <- npdr(as.factor(sex.vec), filtered.mostafavi.df[,-class.idx], 
...
length(sexassoc.idx)
npdr.mdd.sexassoc.rnaseq.results[1:20,] 

topx <- 20
stir.sex.compare <- cbind(rownames(npdr.mdd.rnaseq.results)[1:topx], 
