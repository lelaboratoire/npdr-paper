...
Proper preprocessing of the dataset retains genes with low sex association (Supplementary Fig. S4) and leads to an NPDR runtime of 99 seconds (on the same desktop with an Intel Xeon W-2104 CPU and 32GB of RAM).
