...
Pseudo-code of the NPDR algorithm for continuous or discrete outcome is provided in Algorithm 1.

\begin{figure}[!tpb]%figure1
\centerline{\includegraphics[trim = 0 497 0 120, clip, scale = 0.68]{../../figs/npdr-algo.pdf}}
\caption{Pseudo-code of the NPDR algorithm.}\label{fig:pseudocode}
\end{figure}
